...
//    Route::post('section/set', 'Developro\Section\IndexController@sort')->name('section.sort');
    Route::post('investment.sort', 'Developro\Investment\IndexController@sort')->name('investment.sort');
//
...
//        'file-catalog' => 'File\CatalogController',
        ...
        'charity' => 'Charity\IndexController',
...
//        });
        ...
        Route::resources([
            ...
            'modules' => 'Modules\IndexController',
            'search-field' => 'Search\FieldController',
        ]);

        Route::post('investment-sale-point/set', 'Investment\SalePointController@sort')->name('investment-sale-point.sort');
...
//
        Route::group(['middleware' => 'check.investment.permission', 'prefix' => '/investment', 'as' => 'investment.'], function () {
            Route::resources([
                ...
                '{investment}/url' => 'Page\UrlController',
                ...
                '{investment}/plots' => 'Plots\IndexController',
...
Route::get('{uri}', [MenuController::class, 'index'])
    ->where('uri', '^(?!admin($|/))[A-Za-z0-9\-\/]+$')
    ->name('front.menu.show');
