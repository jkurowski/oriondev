...
<div class="col-12 col-md-6 col-xl-4 mieszkania-list__item scroll-anim-bottom">
    <div class="mieszkania-list__item-wrapper position-relative">
        ...
        @if($property->investment->type == 3 && $property->status <> 3)
            <a class="mieszkania-list__streched-link z-2" href="{{ route('front.developro.house', [
                $property->investment->slug,
                $property,
                Str::slug($property->name),
                round(floatval($property->area), 2).'-m2'
        ...
        <div class="mieszkania-list__flex-wrapper d-flex flex-column align-items-center align-items-lg-start justify-content-start p-15">
            @if($property->file)
                <picture class="m-auto mb-3">
                    ...
                    <img src="{{ asset('/investment/property/list/'.$property->file) }}" alt="{{$property->name}}" loading="lazy" decoding="async" class="mieszkania-list__img">
                </picture>
            @endif
            ...
            <div class="mieszkania-list__icn-items d-flex flex-column flex-lg-row align-items-center align-items-lg-start justify-content-center justify-content-lg-start flex-wrap">
                ...
                {{-- Pokoje --}}
                <div class="mieszkania-list__icn-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30.74" height="30.739" viewBox="0 0 30.74 30.739"> <g id="karta-02" transform="translate(0.75 0.75)"> <path id="Path_28" data-name="Path 28" d="M25,13.208V2H43.031V21.005H37.67V31.239H33.284" transform="translate(-13.792 -2)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/> <path id="Path_29" data-name="Path 29" d="M20.031,33.954l-2.924,2.924H2V13H13.208" transform="translate(-2 -7.64)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/> <path id="Path_30" data-name="Path 30" d="M25,34v6.335" transform="translate(-13.792 -18.406)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/> <path id="Path_31" data-name="Path 31" d="M25,56v2.924" transform="translate(-13.792 -29.685)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/> <path id="Path_32" data-name="Path 32" d="M13.208,41H2" transform="translate(-2 -21.995)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/> </g> </svg>
                    <span class="d-flex flex-row align-items-center justify-content-start gap-10">
                        Pokoje: <div class="mieszkania-list__box">{{ $property->rooms }}</div>
                    </span>
                </div>
                ...
                <div class="mieszkania-list__icn-item">
                    ...
                    <span class="d-flex flex-row align-items-center justify-content-start gap-10">
                        Piętro: <div class="mieszkania-list__box">{{ $property->floor->number ?? '-' }}</div>
                    </span>
                </div>
                @endif
