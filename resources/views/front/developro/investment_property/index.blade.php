            ...
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-center align-items-center">
                    ...
                    @if($investment->type == 2)
                        <a href="{{route('front.developro.floor', [$investment->slug, $floor, 'floorSlug' => Str::slug($floor->name)])}}" class="next-prev__link d-flex align-items-center justify-content-center gap-2">
                            Plan piętra
                        </a>
                    @endif
                </div>
            ...
            <div class="container ">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-10 col-xxl-8 d-flex flex-column flex-md-row align-items-center justify-content-center gap-30  gap-lg-100 mt-20 mt-lg-50 mt-xl-70 mb-30">
                        ...
                        <div class="page-entry-karta__item d-flex flex-row align-items-center justify-content-center gap-15 scroll-anim-top">
                            <x-icons.icon-floor/>
                            <span class="d-flex flex-row align-items-center justify-content-center gap-10">Piętro:<div class="page-entry-karta__box">{{$floor->number}}</div></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="row">
                            <div class="col-12 col-sm-7 d-flex flex-column align-items-start justify-content-start gap-15 scroll-anim-bottom">
                                ...
                                @if($property->highlighted && $property->promotion_price && $property->area)
                                    <div class="page-entry-karta__info-item d-flex flex-column flex-sm-row justify-content-start justify-content-sm-between align-items-center align-items-sm-end w-100" style="color: #FF0000">
                                        <span>Cena promocyjna za m<sup>2</sup></span>
                                        <span><b>@money(($property->promotion_price / $property->area))</b></span>
                                    </div>
                                @endif
                                ...
                                @if($property->price_brutto && $property->area)
                                    <div class="page-entry-karta__info-item d-flex flex-column flex-sm-row justify-content-start justify-content-sm-between align-items-center align-items-sm-end w-100 @if($property->highlighted) text-decoration-line-through text-muted @endif">
                                        ...
                                        <span><b>@money(($property->price_brutto / $property->area))</b></span>
                                    </div>
                                @endif
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            @if($property->file_pdf)
                                                <a href="{{ asset('/investment/property/pdf/'.$property->file_pdf) }}" class="custom-button mt-0mt-md-10" target="_blank">
                                                    @if($property->is_investment_property)
