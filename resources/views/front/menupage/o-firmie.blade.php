...
@section('content')
    <!-- MAIN SECTION -->
    <section id="about" class="pt-6 pb-6">
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="pe-5">
    ...
    <section id="searchForm" class="pt-6 pb-6">
        <div class="container">
            ...
            <form class="row pt-5 mt-5 pb-5 mb-5" method="get">
                ...
                <div class="col">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-outline-secondary dropdown-toggle w-100 select-like" type="button" data-bs-toggle="dropdown" id="investmentBtn">
                            Wszystkie
                        </button>
                ...
                <div class="col">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-outline-secondary dropdown-toggle w-100 select-like" type="button" data-bs-toggle="dropdown" id="areaBtn">
                            Wszystkie
                        </button>
                        <ul class="dropdown-menu w-100">
                            <li><a class="dropdown-item active" href="#" data-value="">Wszystkie</a></li>
                ...
                <div class="col">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-outline-secondary dropdown-toggle w-100 select-like" type="button" data-bs-toggle="dropdown" id="roomsBtn">
                            Wszystkie
                        </button>
                        <ul class="dropdown-menu w-100">
                            <li><a class="dropdown-item active" href="#" data-value="">Wszystkie</a></li>
                ...
                <div class="col">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-outline-secondary dropdown-toggle w-100 select-like" type="button" data-bs-toggle="dropdown" id="priceBtn">
                            Wszystkie
                        </button>
                        <ul class="dropdown-menu w-100">
                            <li><a class="dropdown-item active" href="#" data-value="">Wszystkie</a></li>
