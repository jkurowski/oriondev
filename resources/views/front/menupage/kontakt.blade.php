        ...
        <div class="container">
            <div class="row no-gutters-xl">
                <div class="col-12 col-md-4">
                    <div class="pe-0 pe-lg-3 pe-xxl-5 ps-0 ps-lg-3 ps-xxl-5 h-100">
            ...
            <div class="row">
                <div class="col-12 text-center pt-4 pt-sm-5">
                    <h2>Biuro sprzedaży czynne:</h2>
                    <ul class="list-group col-12 col-md-6 col-xl-4 m-auto mt-3 mt-sm-5">
