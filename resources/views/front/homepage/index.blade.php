            ...
            <div class="container">
                <div class="row">
                    <div class="col-6">
                        ...
                        <img src="images/usmiechnieta-para-w-nowym-mieszkaniu.jpg" alt="" width="700" height="450" class="mt-5">
                    </div>
                    <div class="col-1"></div>
                    <div class="col-5 d-flex align-items-center">
                        <a href="" class="main-invest">
        ...
        <section id="newsList" class="overflow-hidden">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="d-flex justify-content-end h-100 align-items-center gap-3">
                            <button class="slick-button slick-button-left slick-prev-custom">
                            ...
                            <button class="slick-button slick-button-right slick-next-custom">
                ...
                <div class="news-carousel">
                    <div class="news-card px-2">
                        <article itemscope itemtype="https://schema.org/NewsArticle">
                            ...
                            <meta itemprop="headline" content="Lorem ipsum dolor sit amet, consecte ciao elit.">
                            <meta itemprop="datePublished" content="2026-01-12">
                            <meta itemprop="dateModified" content="2026-01-12">
                            <meta itemprop="url" content="https://example.com/aktualnosci/lorem-ipsum">
                            <span itemprop="author" itemscope itemtype="https://schema.org/Organization">
                            <meta itemprop="name" content="Nazwa organizacji">
                        </span>
                            ...
                            <a href="/aktualnosci/lorem-ipsum" class="news-card" aria-label="Lorem ipsum dolor sit amet, consecte ciao elit.">
                                <div class="news-card__thumb">
                                    <img
                                        src="images/news-1.jpg"
                                        alt="Pracownik biurowy z tablicą, w tle para na kanapie"
                                        itemprop="image"
                                        loading="lazy"
                                        width="696"
                                        height="484"
                                ...
                                <span class="news-card__arrow" aria-hidden="true">
                                    ...
                                    <time class="news-card__date" itemprop="datePublished" datetime="2026-01-12">12.01.2026 r.</time>
                                    <h3 class="news-card__title" itemprop="headline">
                                        Lorem ipsum dolor sit amet, consecte ciao elit.
                                    </h3>
                                </div>
                            </a>
                        </article>
